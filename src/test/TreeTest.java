...
//		byte[] bytePicture = picture.getByteArray("C:/Users/Blepoidevin/workspace2.0/Java2Development/RealZipped/download.jpg");
//		
//		HuffmanTree tree = new HuffmanTree(bytePicture);
//		
//		HuffmanCompressor compress = new HuffmanCompressor();
//		byte[] compressedPicture = compress.compress(tree, bytePicture);
//		
//		byte [] decompressedPic = compress.decompress(tree, bytePicture.length, compressedPicture);
//		picture.createImage(decompressedPic, "Uncompressed.jpg");
//	}
